// Identical to Quarto's default typst-show.typ EXCEPT for the two CUSTOM
// lines added just before `doc,` — they thread brand-color/brand-logo into
// article(), which is defined before those values are in scope.
#show: doc => article(
$if(title)$
  title: [$title$],
$endif$
...
$endif$
  ...
  // CUSTOM: pass brand values through as parameters
  brand-primary: brand-color.primary,
  brand-logo-medium: brand-logo.medium,
  doc,
)
